            ...
            <div className="w-2/3 flex">
                {
                    user ?
                    (
                        <div className="w-1/3 flex justify-center items-center text-white hover:cursor-pointer" onClick={logout}>
                            Se déconnecter
                        </div>
                    ) : (
                        <Link to="/login" className="w-1/3 flex justify-center items-center text-white hover:cursor-pointer" onClick={logout}>
                            Se connecter
                        </Link>
                    )
                }
